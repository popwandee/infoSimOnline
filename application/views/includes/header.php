          ...
          <ul class="nav navbar-nav">
            <li class="dropdown tasks-menu">
              ...
              <ul class="dropdown-menu">
                <li class="header"> เข้าสู่ระบบครั้งล่าสุด :
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?php echo base_url(); ?>userEdit" class="btn btn-default btn-flat">
                      <i class="fa fa-key"></i> การตั้งค่าบัญชี </a>
                  </div>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <?php
            ...
            <li class="treeview">
              <a href="<?php echo base_url(); ?>manageInfo">
                <i class="fa fa-tasks"></i>
            ...
            ?>
                <li class="treeview">
                  <a href="<?php echo base_url(); ?>einfo">
                    <i class="fa fa-tasks"></i>
                    <span>ข่าวสาร</span>
                  </a>
              </li>
