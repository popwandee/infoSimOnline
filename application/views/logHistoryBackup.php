...
<body>
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-users"></i>ิบันทึก ประวัตการสำรองข้อมูล
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"> ขนาดตารางบันทึกการสำรองข้อมูลของคุณ:
              <?php
            ...
            <div class="pull-right">
              <a class="btn btn-danger" href="<?php echo base_url(); ?>backupLogTableDelete">ล้างตารางสำรอง</a>
            </div>
            <div class="box-tools">
            </div>
          </div>
