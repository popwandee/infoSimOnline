  ...
  <section class="content">
    <div class="col-xs-12">
      <div class="text-right">
        <a class="btn btn-primary" href="<?php echo base_url(); ?>mAddNewInfo">
                    ...
                    <?php
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <a class="btn btn-sm btn-info" href="<?php echo base_url().'mEditOldInfo/'.$record->infoId; ?>" title="แก้ไข">
                            <i class="fa fa-pencil"></i>
                          </a>
                          <a class="btn btn-sm btn-danger deleteUser" href="<?php echo base_url().'mDeleteInfo/'.$record->infoId; ?>" data-userid="<?php echo $record->infoId; ?>"
                            title="ลบ">
