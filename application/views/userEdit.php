...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            การตั้งค่าบัญชี
            <small>จัดระเบียบข้อมูลของคุณ</small>
        </h1>
    </section>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control required equalTo" placeholder="Confirm Password" id="cpassword2" name="cpassword2" maxlength="20">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
